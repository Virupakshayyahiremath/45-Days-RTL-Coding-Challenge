...
REM
REM Generated by Vivado on Mon Jan 12 15:12:35 +0530 2026
...
echo "xvlog --incr --relax -prj jkff_using_dff_tb_vlog.prj"
call xvlog  --incr --relax -prj jkff_using_dff_tb_vlog.prj -log xvlog.log
