...
REM
REM Generated by Vivado on Sat Jan 10 11:31:47 +0530 2026
...
echo "xvlog --incr --relax -prj dff_en_async_rst_tb_vlog.prj"
call xvlog  --incr --relax -prj dff_en_async_rst_tb_vlog.prj -log xvlog.log
