...
REM
REM Generated by Vivado on Sun Jan 11 16:34:46 +0530 2026
...
echo "xvlog --incr --relax -prj tff_using_dff_tb_vlog.prj"
call xvlog  --incr --relax -prj tff_using_dff_tb_vlog.prj -log xvlog.log
