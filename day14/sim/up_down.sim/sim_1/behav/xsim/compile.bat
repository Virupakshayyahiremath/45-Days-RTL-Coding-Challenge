...
REM
REM Generated by Vivado on Wed Jan 14 15:03:02 +0530 2026
...
echo "xvlog --incr --relax -prj up_down_counter_sc_tb_vlog.prj"
call xvlog  --incr --relax -prj up_down_counter_sc_tb_vlog.prj -log xvlog.log
