...
REM
REM Generated by Vivado on Sun Jan 04 18:10:12 +0530 2026
...
echo "xvlog --incr --relax -prj prien4_2_tb_vlog.prj"
call xvlog  --incr --relax -prj prien4_2_tb_vlog.prj -log xvlog.log
