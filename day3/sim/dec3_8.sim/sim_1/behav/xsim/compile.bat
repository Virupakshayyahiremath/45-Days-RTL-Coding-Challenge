...
REM
REM Generated by Vivado on Fri Jan 02 23:01:46 +0530 2026
...
echo "xvlog --incr --relax -prj dec2_4_tb_vlog.prj"
call xvlog  --incr --relax -prj dec2_4_tb_vlog.prj -log xvlog.log
